...
Title:       "Biopsy Procedure for obtaining a specimen, part of a diagnostic pathway"
Description: """
...
* insert ActorEntity(admissionNurse, "Admission Nurse",         [[TODO]])
...
* process[+]
  ...
  * insert ProcessSearch(1, "Select Admission Forms", admissionNurse, forms, ,  , [[ This may be paper based. If using EPR, this could be prepopulated from the EPR and/or Primary Care record ]])
...
* process[+]
  ...
  * insert ProcessCreateEvent(1, "Complete Admission Forms", admissionNurse, forms, ,  , [[  ]])
