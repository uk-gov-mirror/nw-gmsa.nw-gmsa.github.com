...
| FHIR Organization Type (and ODS Organisation Role)                                                                                                                                                                                                                        | Organization.type              | XON-7 [FHIR Organization Type](http://hl7.org/fhir/ValueSet/organization-type) | Organisation.extension[ODSOrganisationRole]              | 
| Parent [Organsiation Code](https://www.datadictionary.nhs.uk/attributes/organisation_code.html)                                                                                                                                                                           | Organization.partOf            | XON-8                                                                          | Inferred from OrganizationAffliation (codes RE5 and RE6) |
