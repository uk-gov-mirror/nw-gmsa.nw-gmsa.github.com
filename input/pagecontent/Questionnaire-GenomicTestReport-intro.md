...
| Name                     | LOINC   | Value Set / Data Type                                                              | Cardinality | HL7 v2 ORU_RO1 Message                   | HL7 FHIR DiagnosticReport                                                              | HL7 FHIR Resource (RESTful)                               |
|--------------------------|---------|------------------------------------------------------------------------------------|-------------|------------------------------------------|----------------------------------------------------------------------------------------|-----------------------------------------------------------|
| Order Identifier         |         | [Order Identifier](https://nw-gmsa.github.io/R4/OrderIdentifier.html)              | 1..1        | [ORC](hl7v2.html#orc)-2                  | [DiagnosticReport](StructureDefinition-DiagnosticReport.html).basedOn                  | [ServiceRequest](StructureDefinition-ServiceRequest.html) |
