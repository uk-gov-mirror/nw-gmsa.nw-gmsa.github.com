...
```
T25-8ZEA^699X0-iGene^https://fhir.north-west.england.nhs.uk/iGene/ReportNumber^URI
```
    ...
    "identifier": [
          {
            ...
            "system": "https://fhir.north-west.england.nhs.uk/iGene/ReportNumber",
            "type": {
              "coding": [
                {
                  "code": "FILL",
...
| Assigning Authority  | 1..1        | NHS (or X24 for England and W00 for Wales) | ROA                             | Identifier.assigner.value | CX.4      | For MRN the assigning authority shall be the NHS Trust ODS Code. <br/><br/>For NHS identifiers valid values are <br/> NHS - England and Wales <br/> HSNI - Northern Ireland <br/> CHI - Scotland |
