...
| Order Code             |       | [Genomic Test Directory](ValueSet-genomic-test-directory.html)                     | 1..1        | [OBR](hl7v2.html#obr)-4           | [ServiceRequest](StructureDefinition-ServiceRequest.html).code                          |                                                                            |
...
| Suspected Condition    |       | Domain specific - See below                                                        | *..*        | [DG1](hl7v2.html#dg1)-3           | [ServiceRequest](StructureDefinition-ServiceRequest.html).reasonCode                    |                                                                            |
